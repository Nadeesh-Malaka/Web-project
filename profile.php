          ...
          <div class="text-left mb-4">
            <form action="<?php echo BASEURL . '/Process/update_profile.php' ?> "  method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" value="<?php echo $row['Phone']  ?>" name="Phone" class="input" >
               
              </div>
              <div class="mb-3">
                <label for="exampleInputBirthDay" class="form-label">Birth Day</label>
                <input type="text" value="<?php echo $row['Date']  ?>" name="Date" class="input" >

              </div>

              <div class="mb-3">
                <label for="exampleInputaddress" class="form-label">Address</label>
                <input type="text" value="<?php echo $row['Address']  ?>" name="Address" class="input" >

              </div>

              <div class="mb-3">
                <label for="exampleInputSubjectStream" class="form-label">Subject Stream</label>
                <input type="text" value="<?php echo $row['Stream']  ?>" name="Stream" class="input" >

              </div>
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Password</label>
                <input type="text" value="<?php echo $row['Password']  ?>" name="Password" class="input" >
               ...
               <div class="btnbtn">
                <input type="submit" value = "Save " class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">
               
          
                <input type="reset" value = "Rest " class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">
               </div>
          </form>


          <div class="btnbtn2">
          <a href="subjectS.php" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Go to subject stream</a>
          </div>
        </div>
      </div>
    </div>
