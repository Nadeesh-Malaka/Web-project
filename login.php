        ...
        if($result){
            if($result && mysqli_num_rows($result) > 0){
                ...
                if($row['Password'] == $Password ){
                    echo "<script>alert('Logging in successfully...!')</script>";
                    echo "<meta http-equiv='refresh' content='0;url=subjectS.php'>";
                    die;
                }
            } else {
                echo "<script type='text/javascript'> alert('Wrong username or password 1!')</script>";
            }
        } else {
            echo "<script type='text/javascript'> alert('Wrong username or password 2!')</script>";
        }
